    ...
    <div class="card-body pt-1">
        ...
        @csrf
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        <input type="text" class="form-control" id="treatment_id" name="treatment_id" value="{{ $prescription->treatment_id ?? '' }}" autocomplete="off" maxlength="10" required readonly disabled/>
                        <div class="invalid-feedback text-start"></div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btn-back').on('click', function() {
            window.location.href = '{{ url("prescriptionapproval/approval") }}/' + treatmentId;
        });
        ...
        $('#createForm').validate({
            ...
            submitHandler: function(form) {
                ...
                urls = '{{ url("/prescriptionapproval/edit") }}/' + $('#hidden_prescription_id').val();
